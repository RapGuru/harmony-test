					...
					<View style={styles.modal_container}>
						<View style={styles.modal_toolbar}>
							<DatePicker
								...
								customStyles={{dateTouchBody: {backgroundColor: 'red'}}}
						...
						<View style={styles.modal_content_container}>
							...
							<View style={styles.modal_content}>
								<Text>There will be a form here with the parameters for the selected sampling site</Text>
								<TouchableHighlight onPress={() => this.closeWaterOpsModal()}>
